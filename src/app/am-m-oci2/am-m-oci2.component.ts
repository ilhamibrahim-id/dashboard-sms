...
export class AmMOci2Component implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.loaddata = new Promise(resolve => {
      ...
      this.leveltotal = this.service.getReadLevelTotaloci2().subscribe(data => {
      ...
      this.findingsub = this.service.getReadFindingPendingoci2().subscribe(data => {
      ...
      this.totalfindingsub = this.service.getTotalFindingMoci2().subscribe(data => {
        this.totalfm = data;
      ...
      this.totalfindingmsub =  this.service.getTotalPendingFindingMoci2().subscribe(data => {
        this.totalpm = data;
      ...
      this.totalfinishmsub = this.service.getTotalFinsihFindingMoci2().subscribe(data => {
        this.totalffm = data;
      ...
      this.totalreadymsub = this.service.getTotalReadyFindingMoci2().subscribe(data => {
        this.totalrm = data;
